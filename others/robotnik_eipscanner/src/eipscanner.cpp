...
void EIPScanner::ReadInputs()
{
  ...
  // quick fix by aarnal, sorry
  emergency_stop_msg_.data = !inputs_msg_.digital_inputs[eip_configuration_input_.rover_power_enabled_];
  ...
  // quick fix by aarnal, sorry
  safety_module_status_msg_.emergency_stop = !inputs_msg_.digital_inputs[eip_configuration_input_.rover_power_enabled_];
